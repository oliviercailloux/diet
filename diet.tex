...
\section{Analysis}
\commentOC{We should think already now about some of the analysis that we will want to do, in order to ensure that our collection phase is appropriate and to document the programming of the adjudication phase.}
\begin{itemize}
